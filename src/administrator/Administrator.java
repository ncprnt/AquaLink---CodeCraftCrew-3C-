...
public class Administrator implements Initializable {
    ...
    @FXML
    private void handleLoadUserVerification() {
        loadFXML("/userverification/UserVerification.fxml");
    }
    ...
    private void handleLoadFundraise() {
        loadFXML("/fundraise/FundraiseTableView.fxml");
    }

    @FXML
    private void handleLoadDonation() {
        loadFXML("/fundraise/DonationTableView.fxml");
    }

    @FXML
    private void handleLoadFeedback() {
        loadFXML("/feedback/Feedback.fxml");
    }

    @FXML
    private void handleLoadArticle() {
        loadFXML("/article/ArticleForm.fxml");
    }
